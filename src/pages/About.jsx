      ...
      <section className="py-24">
        ...
        <div className="container">
          ...
          <div className="flex flex-wrap justify-center align-middle">
            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700 m-4 w-[270px]">
              <Image
                src="https://media.licdn.com/dms/image/D4E03AQFwwkVu3JvLtw/profile-displayphoto-shrink_800_800/0/1649097731253?e=1688601600&v=beta&t=uGWztkO_uBU_iprqjKFu1wWs-MI5ms5p99_81UEmOKk"
                className="mx-auto mb-6  h-[200px] w-[auto] m-4 shadow-xl  rounded-2.5xl"
                alt="team"
                height={100}
                width={100}
              ...
              <div className="mt-3 flex justify-center space-x-5">
                <a
                  href="https://www.linkedin.com/in/darshan-petkar-5633191aa/"
                  target="_blank"
                  className="group"
                >
                  <svg
            ...
            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700 m-4 w-[270px]">
              <Image
                src="https://media.licdn.com/dms/image/C5603AQEFYusbkB8UCA/profile-displayphoto-shrink_800_800/0/1625833468485?e=1688601600&v=beta&t=xuTRlfhxySpHEi6d2pHd_QdmqYhhOqv29bEfRSMdu-c"
                className="mx-auto mb-6 h-[220px] w-[300px] rounded-2.5xl"
                alt="team"
                height={100}
                width={100}
            ...
            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700 m-4 w-[270px]">
              <Image
                src="https://media.licdn.com/dms/image/D4D03AQHbiAeuHqolLQ/profile-displayphoto-shrink_800_800/0/1681657174195?e=1688601600&v=beta&t=ln8PipbEV8RBq3otDVgt8R1eIqrcg6PFognZtZW98uY"
                className="mx-auto mb-6  h-[200px] w-[auto] m-4 shadow-xl  rounded-2.5xl"
                alt="team"
                height={100}
                width={100}
            ...
            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700 m-4 w-[270px]">
              <Image
                src="https://aniruddha.dev/images/harsh.jpg"
                className="mx-auto mb-6  h-[200px] w-[auto] m-4 shadow-xl  rounded-2.5xl"
                alt="team"
                height={100}
                width={100}
